...
source /home/ubuntu/server_config.sh
WEBSERVER_LOG="/home/ubuntu/src/project_data/repo/apps/$KERNEL_NAME/build/log/webserver.log"
...
SSH_CMD="cd ~/src/project_data/repo && source ./sdaccel_setup && cd apps/$KERNEL_NAME/build"
