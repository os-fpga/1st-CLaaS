...
echo \
 && echo "Running config_static_f2_instance.sh" \
 && echo \
 ...
 && sudo bash -c 'echo "@reboot ubuntu /home/ubuntu/src/project_data/repo/framework/terraform/static_f2_reboot.sh" >> /etc/crontab' \
 && echo \
 && echo "Running reboot script to pre-build and start web server for manual testing." \
 && /home/ubuntu/src/project_data/repo/framework/terraform/static_f2_reboot.sh \
 && echo \
