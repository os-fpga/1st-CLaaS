...
// For |pipe/pe$aa.
logic [3:-29] PIPE_Pe_aa_a2 [3:0],
              PIPE_Pe_aa_a3 [3:0];

// For |pipe/pe$aa_sq.
logic [3:-29] PIPE_Pe_aa_sq_a3 [3:0];

// For |pipe/pe$aa_sq_minus_bb_sq.
logic [3:-29] PIPE_Pe_aa_sq_minus_bb_sq_a3 [3:0];

// For |pipe/pe$aa_sq_plus_bb_sq.
logic [3:-29] PIPE_Pe_aa_sq_plus_bb_sq_a3 [3:0];

// For |pipe/pe$aa_times_bb.
logic [3:-29] PIPE_Pe_aa_times_bb_a3 [3:0];

// For |pipe/pe$aa_times_bb_times_2.
logic [3:-29] PIPE_Pe_aa_times_bb_times_2_a3 [3:0];

// For |pipe/pe$bb.
logic [3:-29] PIPE_Pe_bb_a2 [3:0],
              PIPE_Pe_bb_a3 [3:0];

// For |pipe/pe$bb_sq.
logic [3:-29] PIPE_Pe_bb_sq_a3 [3:0];

// For |pipe/pe$calc_valid.
logic PIPE_Pe_calc_valid_a3 [3:0],
      PIPE_Pe_calc_valid_a4 [3:0];

// For |pipe/pe$depth.
logic [15:0] PIPE_Pe_depth_a0 [3:0],
             PIPE_Pe_depth_a1 [3:0],
             PIPE_Pe_depth_a2 [3:0],
             PIPE_Pe_depth_a3 [3:0];

// For |pipe/pe$depth_out.
logic [3:0] [7:0] PIPE_Pe_depth_out_a3,
                  PIPE_Pe_depth_out_a4;

// For |pipe/pe$done_pix.
logic [3:0] PIPE_Pe_done_pix_a3,
            PIPE_Pe_done_pix_a4;

// For |pipe/pe$done_pix_pulse.
logic PIPE_Pe_done_pix_pulse_a3 [3:0];

// For |pipe/pe$init_pix.
logic PIPE_Pe_init_pix_a1 [3:0],
      PIPE_Pe_init_pix_a2 [3:0],
      PIPE_Pe_init_pix_a3 [3:0];

// For |pipe/pe$pix_h.
logic [31:0] PIPE_Pe_pix_h_a0 [3:0],
             PIPE_Pe_pix_h_a1 [3:0],
             PIPE_Pe_pix_h_a2 [3:0];

// For |pipe/pe$pix_v.
logic [31:0] PIPE_Pe_pix_v_a0 [3:0],
             PIPE_Pe_pix_v_a1 [3:0],
             PIPE_Pe_pix_v_a2 [3:0];

// For |pipe/pe$reset.
logic PIPE_Pe_reset_a0 [3:0],
      PIPE_Pe_reset_a1 [3:0],
      PIPE_Pe_reset_a2 [3:0],
      PIPE_Pe_reset_a3 [3:0];

// For |pipe/pe$wrap_h.
logic [3:0] PIPE_Pe_wrap_h_a1,
            PIPE_Pe_wrap_h_a2,
            PIPE_Pe_wrap_h_a3,
            PIPE_Pe_wrap_h_a4;

// For |pipe/pe$wrap_v.
logic [3:0] PIPE_Pe_wrap_v_a1,
            PIPE_Pe_wrap_v_a2,
            PIPE_Pe_wrap_v_a3,
            PIPE_Pe_wrap_v_a4;

// For |pipe/pe$xx.
logic [3:-29] PIPE_Pe_xx_a2 [3:0],
              PIPE_Pe_xx_a3 [3:0];

// For |pipe/pe$xx_mul.
logic [2:-39] PIPE_Pe_xx_mul_a2 [3:0];

// For |pipe/pe$yy.
logic [3:-29] PIPE_Pe_yy_a2 [3:0],
              PIPE_Pe_yy_a3 [3:0];

// For |pipe/pe$yy_mul.
logic [2:-39] PIPE_Pe_yy_mul_a2 [3:0];
...
generate
   ...
   //
      ...
      // For $init_pixels.
      always_ff @(posedge clk) PIPE_init_pixels_a1 <= PIPE_init_pixels_a0;
      ...
      // Scope: /pe[3:0]
      //
      for (pe = 0; pe <= 3; pe++) begin : L1gen_PIPE_Pe
         // For $aa.
         ...
         always_ff @(posedge clk) PIPE_Pe_wrap_h_a4[pe] <= PIPE_Pe_wrap_h_a3[pe];
         ...
         always_ff @(posedge clk) PIPE_Pe_wrap_v_a4[pe] <= PIPE_Pe_wrap_v_a3[pe];
